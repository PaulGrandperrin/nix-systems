# inspired by https://github.com/NixOS/nixpkgs/blob/master/nixos/modules/virtualisation/google-compute-config.nix

{ config, lib, pkgs, modulesPath, ... }:
with lib;
{
  imports = [
    #../profiles/headless.nix # we can have a kinda working tty on gcp
    #../profiles/qemu-guest.nix # already included in hardware-configuration.nix
  ];
