{pkgs, inputs, lib, ...}: let 
  ...
  #  name = "rust-analyzer";
  #  paths = [ inputs.nixos-23-05.legacyPackages.${pkgs.system}.rust-analyzer ];
...
in {
  ...
  #  vscode = {
  #    extensions = [
  #      (inputs.nixos-23-05.legacyPackages.${pkgs.system}.vscode-extensions.matklad.rust-analyzer.override {
