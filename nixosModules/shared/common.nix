{ config, pkgs, lib, inputs, home-manager-flake, ... }:
{
  ...
  environment.systemPackages = with pkgs; [
    ...
    (writeShellScriptBin  # from https://github.com/NixOS/nixpkgs/pull/524072
      "umount.fuse"
      ''
        FUSE_HELPER=/run/wrappers/bin/fusermount3 # SUID bit needed
        ...
        exec "$FUSE_HELPER" "''${fuse_args[@]}"
        
        echo "umount.fuse: exec failed: $FUSE_HELPER" >&2
